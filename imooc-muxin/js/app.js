window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
// 	nettyServerUrl: 'ws://192.168.2.180:8088/ws',
	nettyServerUrl: 'ws://47.100.242.128:8088/ws'
	/**
	 * 后端服务发布的url地址
	 */
	// serverUrl: 'http://192.168.2.180:8080',
	serverUrl: 'http://47.100.242.128:8080',
	
	/**
	 * 图片服务器的url地址
	 */
	// imgServerUrl: 'http://192.168.2.162:88/gnn/',
	imgServerUrl: 'http://47.100.242.128:88/gnn/',
	 ...
	 * @param {Object} msgId
	 */
	NettyChatMsg: function(senderId, receiverId, msg, msgId){
	 ...
	 * @param {Object} extend
	 */
	DataContent: function(action, nettyChatMsg, extend){
		this.action = action;
